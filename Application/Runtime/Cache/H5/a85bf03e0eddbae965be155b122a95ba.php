...
<body>
    ...
    <div class="wrap ">
        ...
        <div class="teacher-top">
            ...
            <div class="teacher-sex1">
                <?php if($data['sex'] == 1): ?><div class="teacher-sex">性别：<span>男</span><img src="/xiangyi/img/man_03.png" alt="" class="tc-pic"></div>
                    <!-- <div class="sex-img">
                        <img src="/xiangyi/img/man_03.png" alt="" class="tc-pic">
                    </div> -->
                <?php elseif($data['sex'] == 2): ?>
                    <div class="teacher-sex">性别：<span>女</span><img src="/xiangyi/img/teach-sex_07.png" alt="" class="tc-pic"></div>
                    <!-- <div class="sex-img">
                        <img src="/xiangyi/img/teach-sex_07.png" alt="" class="tc-pic">
                    </div> -->
                <?php else: ?>
    ...
    <ul class="teacher-cent" >
        <li>
            <div class="teacher-left">
                <img src="/xiangyi/img/teacher-pics_05.jpg" alt="" class="tc_pi1">
                <p>学院</p>
            </div>
            <p class="teacher-right"><?php echo ($data['a_name']); ?></p>
        </li>
        <li>
            <div class="teacher-left">
                <img src="/xiangyi/img/teacher-pics_08.jpg" alt="" class="tc_pi1">
                <p>电话</p>
            </div>
            <p class="teacher-right"><?php echo ($data['mobile']); ?></p>
        </li>
        <li>
            <div class="teacher-left">
                <img src="/xiangyi/img/teacher-pics_10.jpg" alt="" class="tc_pi1">
                <p>工号</p>
            </div>
            <p class="teacher-right"><?php echo ($data['job_number']); ?></p>
        </li>
        <li>
            <div class="teacher-left">
                <img src="/xiangyi/img/teacher-pics_12.png" alt="" class="tc_pi1">
                <p>互动时间余额</p>
            </div>
            <p class="teacher-right"><?php echo ($data['m_a_time']); ?></p>
        </li>
